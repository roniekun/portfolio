...
const Services = () => {
  return (
          <div className='p-[5vw] flex flex-col lg:gap-5 gap-2 mt-14'>
              <h1 className='uppercase text-2xl font-semibold primary-font my-5 text-blue-600'>what i do</h1>
              <p className='text-xl leading-tight md:w-3/4  self-end primary-font'>
